...
def main():
    ...
    for ins_id, ins in enumerate(tqdm(data)):
        ...
        if gold_docs_inlang and gold_docs_outlang:
            ...
            meta_info = {"index": ins['index'], "answer_text": list(set(ins['gold_answers']))}
            prompts = []
            ...
            for id_outlang_gold_docs, _outlang_gold_docs in enumerate(outlang_gold_docs):
                ...
                meta_info[f'answer_text_out_{id_outlang_gold_docs}'] = list(set(_outlang_gold_docs['gold_answers']))
