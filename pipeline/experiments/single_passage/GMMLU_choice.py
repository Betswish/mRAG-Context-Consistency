...
def main():
    ...
    save_dir = f"results/{task}_choice/"
    ...
    for ins_id, ins in enumerate(tqdm(data)):
        ...
        if gold_docs_inlang and gold_docs_outlang:
            ...
            for _inlang_gold_docs in inlang_gold_docs:
                ...
                prompt_ctx_inlang = make_prompt(tokenizer, args.mname, instructions[args.lang], content_ctx_inlang)
            ...
            for id_outlang_gold_docs, _outlang_gold_docs in enumerate(outlang_gold_docs):
                ...
                prompt_ctx_outlang = make_prompt(tokenizer, args.mname, instructions[args.lang], content_ctx_outlang)
