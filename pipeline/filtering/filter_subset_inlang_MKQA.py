...
save_file = "metadata/has_answer_list_MKQA.txt"
...
for lang in langs:
    ...
    if not os.path.exists("data_inlang_MKQA_filter/"):
        os.makedirs("data_inlang_MKQA_filter/")

    with open(f"data_inlang_MKQA_filter/{lang}_gtr_top30.json", 'w', encoding='utf-8') as f:
